...
namespace Negocio.Validaciones
{
    public class ValidadorTorneo : AbstractValidator<Torneo>
    {
        ...
        public ValidadorTorneo(TorneoContext db, IConfiguration configuration)
        {
            _db = db;
        ...
        {
            string urlBlob = _configuration.GetValue<string>("Rutaimagen");
            return urlLogo.StartsWith(urlBlob);
        }
