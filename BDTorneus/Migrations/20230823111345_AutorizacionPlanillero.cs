...
{
    /// <inheritdoc />
    public partial class AutorizacionPlanillero : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "AutorizacionesPlanilleros",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UsuarioIdOrganizadorId = table.Column<int>(type: "int", nullable: false),
                    UsuarioIdPlanilleroId = table.Column<int>(type: "int", nullable: false),
                    TorneoId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AutorizacionesPlanilleros", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AutorizacionesPlanilleros_Torneos_TorneoId",
                        column: x => x.TorneoId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AutorizacionesPlanilleros_TorneoId",
